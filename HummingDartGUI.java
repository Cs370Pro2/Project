...
public class HummingDartGUI extends JFrame implements ActionListener{
	static JFrame airframe = new JFrame("HummingDart Info");
	static JLabel airlabel = new JLabel("HummingDart Info:");
